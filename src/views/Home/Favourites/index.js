...
const Favourites = () => {
    const data = [
        { id: 1, image: ImgProduct1, title: 'Lorem ipsum dolor', price: 300, originPrice: 400, desc: 'Sold by Maker 1' },
        { id: 2, image: ImgProduct2, title: 'Erya Cutting Board', price: 35, desc: 'Sold by Maker 1' },
        { id: 3, image: ImgProduct3, title: '3 Legged Stool', price: 89, desc: 'Sold by Maker 1' },
        { id: 4, image: ImgProduct4, title: 'Mirage Tapestry Blanket', price: 125, desc: 'Sold by Maker 1', hasDrag: true },
    ];
    return (
        <div className='w-full mt-[40px] lg:mt-[87px] px-5 md:px-10 flex flex-col justify-center items-center'>
            <div className='w-full max-w-screen-main'>
                <div className='w-full flex justify-between items-center'>
                    <h3 className='font_powergrotesk text-lg leading-[22px] lg:text-2xl lg:leading-[28px] font-semibold tracking-[0.015em] text-black uppercase'>OUR FAVOURITES</h3>
